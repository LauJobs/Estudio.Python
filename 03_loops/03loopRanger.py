## Ranger 
# es para crear una secuencia de numeros. puede ser muy util en blucles for, pero tambien para otras cosas ç
#Ranger no es una lista, no crea un lista en memoria si no que va creando conforme lo necesita.
print("\nRanger")
